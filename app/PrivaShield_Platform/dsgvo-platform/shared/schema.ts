...
export const avv = sqliteTable("avv", {
  ...
  datenarten: text("datenarten"),
  betroffenePersonen: text("betroffene_personen"),
  technischeMassnahmen: text("technische_massnahmen"),
  pruefintervall: text("pruefintervall"),
  subauftragnehmerHinweis: text("subauftragnehmer_hinweis"),
  notizen: text("notizen"),
  createdAt: text("created_at").default(new Date().toISOString()),
  updatedAt: text("updated_at").default(new Date().toISOString()),
});
...
export const dsfa = sqliteTable("dsfa", {
  ...
  beschreibung: text("beschreibung"),
  zweck: text("zweck"),
  prozessablauf: text("prozessablauf"),
  verarbeitungskontext: text("verarbeitungskontext"),
  datenquellen: text("datenquellen"),
  empfaenger: text("empfaenger"),
  drittlandtransfer: integer("drittlandtransfer", { mode: "boolean" }).default(false),
  auftragsverarbeiter: text("auftragsverarbeiter"),
  technologienSysteme: text("technologien_systeme"),
  profiling: integer("profiling", { mode: "boolean" }).default(false),
  automatisierteEntscheidung: integer("automatisierte_entscheidung", { mode: "boolean" }).default(false),
  notwendigkeit: text("notwendigkeit"),
  rechtsgrundlage: text("rechtsgrundlage"),
  zweckbindungBewertung: text("zweckbindung_bewertung"),
  datenminimierungBewertung: text("datenminimierung_bewertung"),
  speicherbegrenzungBewertung: text("speicherbegrenzung_bewertung"),
  transparenzBewertung: text("transparenz_bewertung"),
  betroffenenrechteBewertung: text("betroffenenrechte_bewertung"),
  zugriffskonzeptBewertung: text("zugriffskonzept_bewertung"),
  privacyByDesignBewertung: text("privacy_by_design_bewertung"),
  risiken: text("risiken").default("[]"), // JSON [{ titel, beschreibung, betroffeneRechte, betroffeneGruppen, datenarten, ursache, bestehendeKontrollen, eintrittswahrscheinlichkeit, schweregrad, inhärentesRisiko, restrisiko, weitereMassnahmen, verantwortlicher, status }]
  massnahmen: text("massnahmen"),
  restrisikoBegruendung: text("restrisiko_begruendung"),
  art36Erforderlich: integer("art36_erforderlich", { mode: "boolean" }).default(false),
  art36Begruendung: text("art36_begruendung"),
  ...
  verantwortlicherBereich: text("verantwortlicher_bereich"),
  dsbBeteiligt: integer("dsb_beteiligt", { mode: "boolean" }).default(false),
  dsbStellungnahme: text("dsb_stellungnahme"),
  freigabeentscheidung: text("freigabeentscheidung"),
  freigabeBegruendung: text("freigabe_begruendung"),
...
export const audits = sqliteTable("audits", {
  ...
  verknuepftePdcaIds: text("verknuepfte_pdca_ids").default("[]"),
...
export const pdca = sqliteTable("pdca", {
  ...
  verknuepftesAuditId: integer("verknuepftes_audit_id"),
